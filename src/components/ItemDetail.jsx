...
const ItemDetail = () => {
    ...
    function selectImage(e) {
        ...
        //verifico que carousel está activo
        if (popCarousel) {
                ...
                {isLoading ?
                    ...
                    <div className="flex flex-col lg:flex-row justify-center items-center lg:gap-28 lg:pt-[85px] ">
                        ...
                        <div className="max-w-[440px] desktop-disabled mobile-active relative ">
                            ...
                            <div className='flex justify-center items-center w-10 h-10 rounded-full bg-gray-50 cursor-pointer absolute top-1/2 right-0 mr-4gi transform -translate-y-1/2' onClick={nextImage} id={imageId} >
                                <img src={next} alt="next" className=' rounded-full' />
                            </div>
